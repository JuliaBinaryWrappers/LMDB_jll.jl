# `LMDB_jll.jl` (v0.9.35+0)

[![deps](https://juliahub.com/docs/LMDB_jll/deps.svg)](https://juliahub.com/ui/Packages/General/LMDB_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/2df80a4c11144ab0f75b944f64d664ebd94c45a9/L/LMDB/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://git.openldap.org/openldap/openldap.git (revision: `cfb061a8f7879f865536fee7d1d8d9737833bbdb`)
