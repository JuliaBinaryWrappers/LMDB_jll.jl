...
const liblmdb_splitpath = ["bin", "liblmdb.dll"]
...
const liblmdb = "liblmdb.dll"


# Relative path to `mdb_copy`
const mdb_copy_splitpath = ["bin", "mdb_copy.exe"]
...
const mdb_dump_splitpath = ["bin", "mdb_dump.exe"]
...
const mdb_load_splitpath = ["bin", "mdb_load.exe"]
...
const mdb_stat_splitpath = ["bin", "mdb_stat.exe"]
