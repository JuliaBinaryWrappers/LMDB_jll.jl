...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LMDB_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("6206cf0b-f360-5984-af49-5437264c140e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LMDB", artifacts_toml) for e in artifacts["LMDB"]]
...
if best_platform === nothing
    @debug("Unable to load LMDB; unsupported platform $(triplet(platform_key_abi()))")
else
